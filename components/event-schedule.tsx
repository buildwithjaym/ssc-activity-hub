...
export function EventSchedule() {
  return (
    <section id="schedule" className="bg-[#F8F5EF] px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-4 leading-relaxed text-slate-600">
            ...
            competitions, and celebrations prepared by the Supreme Student Council.
          </p>
        </div>
        ...
        <div className="relative mt-14 space-y-8">
          ...
          {schedule.map((item,index)=>(
            ...
            >
              ...
              <div className="absolute left-0 top-6 flex h-10 w-10 items-center justify-center rounded-full border border-[#D4AF37]/40 bg-[#0A2A1F] text-sm font-bold text-[#D4AF37] shadow-lg">
              ...
              <div className="group rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                ...
                <span className="inline-flex rounded-full bg-[#0A2A1F]/5 px-3 py-1 text-xs font-bold text-[#0A2A1F]">
                  {item.category}
                </span>
                ...
                <div className="mt-5 flex flex-col gap-3 border-t border-slate-100 pt-5 text-sm text-slate-600 sm:flex-row sm:gap-8">
